...
impl Trade { pub fn new(s: String, qty: f64, p: f64, dir: Direction) -> Self { Self { symbol: s, size: qty, price: p, direction: dir, time: "now".into() } } pub fn direction_str(&self) -> String { match self.direction { Direction::Long => "LONG".into(), Direction::Short => "SHORT".into(), Direction::Flat => "FLAT".into() } } }
